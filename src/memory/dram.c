...
uint64_t read64bits_dram(uint64_t paddr)
{
    ...
    result |= ((uint64_t)physical_memory[paddr + 3]) << 24;
    result |= ((uint64_t)physical_memory[paddr + 4]) << 32;
    result |= ((uint64_t)physical_memory[paddr + 5]) << 40;
    result |= ((uint64_t)physical_memory[paddr + 6]) << 48;
    result |= ((uint64_t)physical_memory[paddr + 7]) << 56;
